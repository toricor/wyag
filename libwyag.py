...
examle, repo_file(r, \"refs\" \"remotes\", \"origin\", \"HEAD\" will create
...
whatever it takes to convert it into a meaningful representation. What exactory that means depend on each subclass."""
...
def ref_list(repo, path=None):
    ...
    # an OrderedDict and short the output of listdir
...
argsp.add_argument("-a",
                   ...
                   help="Whatever to create a tag object")
...
This function is aware of:
  ...
  - remote branches"""
    ...
    smallHashRE = re.compile(r"^[0-9A-Fa-f]$")
